<template>
  <div
    class="reading-progress-container fixed top-0 left-0 w-full z-50 h-1 bg-gray-200"
    :class="{ 'opacity-0': !showProgress, 'opacity-100': showProgress }"
  >
    <div
      class="reading-progress-bar h-full bg-gradient-to-r from-blue-500 to-purple-500 transition-all duration-300 ease-out"
