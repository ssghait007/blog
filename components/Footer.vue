<template>
  <footer class="text-gray-600 body-font">
    <div
      class="px-5 py-12 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col"
    >
      <div
      ...
      >
        <div
          v-for="i in ['Frontend', 'Backend', 'Databases', 'Proxies']"
          :key="i"
