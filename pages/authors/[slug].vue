<template>
  <div class="min-h-screen bg-white dark:bg-gray-900">
    <div class="max-w-4xl mx-auto px-4 py-8">
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 mb-8">
        ...
        >
          ...
          <div class="flex-1 text-center md:text-left">
            ...
            <!-- Author Details -->
            <div
              class="flex flex-wrap justify-center md:justify-start gap-4 text-sm text-gray-500 dark:text-gray-400 mb-6"
            >
              ...
              <div v-if="author.joinedDate" class="flex items-center gap-1">
                ...
                Joined {{ _formatDate(author.joinedDate) }}
              </div>
            </div>
      ...
      <!-- Specialties -->
      <div
        v-if="author.specialties && author.specialties.length"
        ...
        >
          ...
          >
            <NuxtLink :to="post._path">
              ...
              <div class="p-4">
                <h3
                  class="font-semibold text-gray-900 dark:text-white mb-2 hover:text-indigo-600 dark:hover:text-indigo-400"
                >
                  {{ post.title }}
                </h3>
                ...
                <div class="text-xs text-gray-500 dark:text-gray-400">
                  {{ _formatDate(post.createdAt) }} • {{ post.readingTime }}
                </div>
              </div>
            </NuxtLink>
          </article>
